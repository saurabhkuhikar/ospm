...
/**
 * CylinderBookingsSearch represents the model behind the search form of `app\models\CylinderBookings`.
 */
class CylinderBookingsSearch extends CylinderBookings
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['first_name', 'last_name', 'user_id', 'covid_test_result', 'covid_test_date', 'cylinder_type', 'cylinder_quantity', 'total_amount', 'order_date', 'order_status', 'payment_id', 'payment_token', 'payment_status', 'created', 'updated'], 'safe'],
        ];
    }
