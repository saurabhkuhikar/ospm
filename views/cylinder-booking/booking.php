                    ...
                    <div class="col-md-12">
                        <?php $form = ActiveForm::begin(['id'=>'msform']); ?>
                            ...
                            <fieldset>
                                ...
                                </div> <input type="button" name="previous" class="previous action-button-previous" value="Previous" /> <input type="button" name="next" class=" next action-button-conform" value="Conform" />
                            </fieldset>
                            <fieldset>
                                <div class="form-card">                                    
